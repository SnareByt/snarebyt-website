...
export default async function SiteEditorPage() {
  ...
  const assets = media.map((a) => ({
    id: a.id, kind: a.kind, filename: a.filename, url: publicUrl(a.objectKey), alt: a.alt,
  }));
  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <SiteEditor pages={rows} specs={SECTION_SPECS} assets={assets} />
